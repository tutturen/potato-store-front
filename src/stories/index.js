...
storiesOf('ProductPage', module)
  .add('with initial props', () => <Layout {...emptyProps}><ProductPage {...emptyProps}/></Layout>)
  .add('with three items in cart', () => <Layout {...threeItemsInCartProps}><ProductPage {...threeItemsInCartProps}/></Layout>);
